...
app.config(['$routeProvider', 
    function($routeProvider) {
      ...
      .when('/players/:playerId',           { templateUrl: 'views/leagues/view.html', authRequired: true })
      ...
      .when('/fantasyteams/:leagueId',      { templateUrl: 'views/fantasyteams/view.html', authRequired: true })
      .when('/fantasyteams/:leagueId/edit', { templateUrl: 'views/fantasyteams/edit.html', authRequired: true })
